...
const getPistonLanguage = (language) => {
  const languageMap = {
    "C++": "cpp",
...
export default function CodeEditor() {
  ...
  const handleRunCode = () => {
    ...
    if (pistonLanguage) {
      ...
      alert(`The selected language "${currentFile.language}" is not supported for execution.`);
    }
  };
      ...
      <div className="flex justify-between items-center p-4 text-white bg-zinc-800 border-b border-zinc-700">
        <Select onValueChange={handleLanguageChange} value={files[activeFile].language}>
          ...
          <SelectContent className="bg-zinc-900 text-white border-zinc-700">
            {["C++", "JavaScript", "TypeScript", "Python", "Java"].map((lang) => (
