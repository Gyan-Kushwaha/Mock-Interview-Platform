      ...
      <div className="w-full max-w-4xl mx-auto bg-zinc-600 shadow-lg rounded-lg overflow-hidden">
        <div className="p-6">
          ...
          <div className="space-y-4">
            <div>
              <h3 className="text-lg text-zinc-200 font-semibold">Target Company</h3>
              <p className="text-zinc-300">{interview.targetCompany}</p>
            </div>
            <div>
              <h3 className="text-lg text-zinc-200 font-semibold">Overall Review</h3>
              <p className="text-zinc-300">{interview.overallReview}</p>
            </div>
            {interview.dsaQuestions && (
              <QuestionList title="DSA Questions" questions={interview.dsaQuestions} />
            )}
            {interview.technicalQuestions && (
              <QuestionList title="Technical Questions" questions={interview.technicalQuestions} />
            )}
            {interview.coreSubjectQuestions && (
              <QuestionList title="Core Subject Questions" questions={interview.coreSubjectQuestions} />
            )}
          </div>
        </div>
      </div>
